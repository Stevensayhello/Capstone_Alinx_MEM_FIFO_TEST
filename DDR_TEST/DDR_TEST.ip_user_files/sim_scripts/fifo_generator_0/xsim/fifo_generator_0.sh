...
#
# Generated by Vivado on Thu Nov 25 04:00:33 -0800 2021
...
simulate()
{
  xsim fifo_generator_0 -key {Behavioral:sim_1:Functional:fifo_generator_0} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_9054.protoinst" -log simulate.log
}
